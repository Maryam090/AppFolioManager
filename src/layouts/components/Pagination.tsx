        ...
        >
          ...
          {hasPrevPage ? (
            <a
              ...
              className="px-2 py-2 text-text-dark transition-colors duration-300 hover:bg-light rounded-md"
            >
            ...
            <span className="px-2 py-2 text-text-light transition-colors duration-300 rounded-md">
              <span className="sr-only">Previous</span>
              <svg
                viewBox="0 0 20 20"
                fill="currentColor"
